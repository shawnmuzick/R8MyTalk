...
document.addEventListener('DOMContentLoaded', async function() {
    const eventName = document.getElementById('eventNameDisplay').getAttribute('data-event-name'); //get the eventName from the title
    ...
    return new Chart(canvasElement, {
        ...
        data: {
            ...
            datasets: [{
                ...
                backgroundColor: [
                    'rgb(255, 0, 0)', 'rgb(255, 167, 0)', 'rgb(255, 244, 0)', 'rgb(163, 255, 0)', 'rgb(44, 186, 0)',
                ],
                borderWidth: 2
            }],
        },
